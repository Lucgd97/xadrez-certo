...
namespace xadrez
{
    class PartidaDeXadrez
    {
        ...
        public void validarPosicaoDeOrigem(Posicao pos)
        {
            ...
            {
                throw new TabuleiroException("Não há movimentos possíveis para a peça de orgiem escolhida!");
            }
        }
